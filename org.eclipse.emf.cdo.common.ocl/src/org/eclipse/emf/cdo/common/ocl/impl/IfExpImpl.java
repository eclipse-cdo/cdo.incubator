 ...
 * </copyright>
 *
 * $Id: IfExpImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.cdo.common.ocl.impl.IfExpImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.common.ocl.impl.IfExpImpl#getThenExpression <em>Then Expression</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.common.ocl.impl.IfExpImpl#getElseExpression <em>Else Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfExpImpl
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.IfExp.class)
    {
      ...
      {
        case OCLPackage.IF_EXP__CONDITION: return ExpressionsPackage.IF_EXP__CONDITION;
        case OCLPackage.IF_EXP__THEN_EXPRESSION: return ExpressionsPackage.IF_EXP__THEN_EXPRESSION;
        case OCLPackage.IF_EXP__ELSE_EXPRESSION: return ExpressionsPackage.IF_EXP__ELSE_EXPRESSION;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.IfExp.class)
    {
      ...
      {
        case ExpressionsPackage.IF_EXP__CONDITION: return OCLPackage.IF_EXP__CONDITION;
        case ExpressionsPackage.IF_EXP__THEN_EXPRESSION: return OCLPackage.IF_EXP__THEN_EXPRESSION;
        case ExpressionsPackage.IF_EXP__ELSE_EXPRESSION: return OCLPackage.IF_EXP__ELSE_EXPRESSION;
        default: return -1;
      }
    }
