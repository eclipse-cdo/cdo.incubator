 ...
 * </copyright>
 *
 * $Id: TupleLiteralPartImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public class TupleLiteralPartImpl
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.TUPLE_LITERAL_PART__START_POSITION, oldStartPosition, startPosition));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.TUPLE_LITERAL_PART__END_POSITION, oldEndPosition, endPosition));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.TUPLE_LITERAL_PART__TYPE_START_POSITION, oldTypeStartPosition, typeStartPosition));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.TUPLE_LITERAL_PART__TYPE_END_POSITION, oldTypeEndPosition, typeEndPosition));
  }
   ...
   */
    ...
    if (attribute != null && ((EObject)attribute).eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OCLPackage.TUPLE_LITERAL_PART__ATTRIBUTE, oldAttribute, attribute));
      }
    }
    return attribute;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.TUPLE_LITERAL_PART__ATTRIBUTE, oldAttribute, attribute));
  }
   ...
   */
    ...
    if (baseClass == ASTNode.class)
    {
      switch (derivedFeatureID)
      {
        case OCLPackage.TUPLE_LITERAL_PART__START_POSITION: return UtilitiesPackage.AST_NODE__START_POSITION;
        case OCLPackage.TUPLE_LITERAL_PART__END_POSITION: return UtilitiesPackage.AST_NODE__END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == TypedASTNode.class)
    {
      switch (derivedFeatureID)
      {
        case OCLPackage.TUPLE_LITERAL_PART__TYPE_START_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION;
        case OCLPackage.TUPLE_LITERAL_PART__TYPE_END_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == org.eclipse.ocl.expressions.TupleLiteralPart.class)
    {
      switch (derivedFeatureID)
      {
        case OCLPackage.TUPLE_LITERAL_PART__VALUE: return ExpressionsPackage.TUPLE_LITERAL_PART__VALUE;
        case OCLPackage.TUPLE_LITERAL_PART__ATTRIBUTE: return ExpressionsPackage.TUPLE_LITERAL_PART__ATTRIBUTE;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == ASTNode.class)
    {
      switch (baseFeatureID)
      {
        case UtilitiesPackage.AST_NODE__START_POSITION: return OCLPackage.TUPLE_LITERAL_PART__START_POSITION;
        case UtilitiesPackage.AST_NODE__END_POSITION: return OCLPackage.TUPLE_LITERAL_PART__END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == TypedASTNode.class)
    {
      switch (baseFeatureID)
      {
        case UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION: return OCLPackage.TUPLE_LITERAL_PART__TYPE_START_POSITION;
        case UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION: return OCLPackage.TUPLE_LITERAL_PART__TYPE_END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == org.eclipse.ocl.expressions.TupleLiteralPart.class)
    {
      switch (baseFeatureID)
      {
        case ExpressionsPackage.TUPLE_LITERAL_PART__VALUE: return OCLPackage.TUPLE_LITERAL_PART__VALUE;
        case ExpressionsPackage.TUPLE_LITERAL_PART__ATTRIBUTE: return OCLPackage.TUPLE_LITERAL_PART__ATTRIBUTE;
        default: return -1;
      }
    }
