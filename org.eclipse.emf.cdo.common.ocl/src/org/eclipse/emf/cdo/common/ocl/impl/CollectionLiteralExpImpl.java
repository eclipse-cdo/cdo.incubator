 ...
 * </copyright>
 *
 * $Id: CollectionLiteralExpImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public class CollectionLiteralExpImpl
   ...
   */
    ...
    if (part == null)
    {
      part = new EObjectContainmentEList<CollectionLiteralPart<CDOClassifier>>(CollectionLiteralPart.class, this, OCLPackage.COLLECTION_LITERAL_EXP__PART);
    }
    return part;
  }
   ...
   */
    ...
    switch (featureID)
    {
      ...
      case OCLPackage.COLLECTION_LITERAL_EXP__PART:
        getPart().clear();
        getPart().addAll((Collection<? extends CollectionLiteralPart<CDOClassifier>>)newValue);
        return;
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.CollectionLiteralExp.class)
    {
      ...
      {
        case OCLPackage.COLLECTION_LITERAL_EXP__KIND: return ExpressionsPackage.COLLECTION_LITERAL_EXP__KIND;
        case OCLPackage.COLLECTION_LITERAL_EXP__PART: return ExpressionsPackage.COLLECTION_LITERAL_EXP__PART;
        case OCLPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE: return ExpressionsPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.CollectionLiteralExp.class)
    {
      ...
      {
        case ExpressionsPackage.COLLECTION_LITERAL_EXP__KIND: return OCLPackage.COLLECTION_LITERAL_EXP__KIND;
        case ExpressionsPackage.COLLECTION_LITERAL_EXP__PART: return OCLPackage.COLLECTION_LITERAL_EXP__PART;
        case ExpressionsPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE: return OCLPackage.COLLECTION_LITERAL_EXP__SIMPLE_RANGE;
        default: return -1;
      }
    }
