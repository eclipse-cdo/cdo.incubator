 ...
 * </copyright>
 *
 * $Id: SendSignalActionImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public class SendSignalActionImpl
    ...
    if (signal != null && signal.eIsProxy())
    {
      ...
      if (signal != oldSignal)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, OCLPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
      }
    }
    return signal;
  }
   ...
   */
    ...
    signal = newSignal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
  }
