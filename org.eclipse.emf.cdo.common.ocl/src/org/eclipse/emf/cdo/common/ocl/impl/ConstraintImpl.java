 ...
 * </copyright>
 *
 * $Id: ConstraintImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public class ConstraintImpl
   ...
   */
    ...
    {
      constrainedElements = new EObjectResolvingEList<CDONamedElement>(CDONamedElement.class, this, OCLPackage.CONSTRAINT__CONSTRAINED_ELEMENTS);
    }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.CONSTRAINT__STEREOTYPE, oldStereotype, stereotype));
  }
   ...
   */
    ...
    switch (featureID)
    {
      ...
      case OCLPackage.CONSTRAINT__CONSTRAINED_ELEMENTS:
        ...
        getConstrainedElements().addAll((Collection<? extends CDONamedElement>)newValue);
        return;
      case OCLPackage.CONSTRAINT__STEREOTYPE:
