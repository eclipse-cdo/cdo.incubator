 ...
 * </copyright>
 *
 * $Id: LoopExpImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.cdo.common.ocl.impl.LoopExpImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.eclipse.emf.cdo.common.ocl.impl.LoopExpImpl#getIterator <em>Iterator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LoopExpImpl
   ...
   */
    ...
    if (iterator == null)
    {
      iterator = new EObjectContainmentEList<Variable<CDOClassifier, CDOParameter>>(Variable.class, this, OCLPackage.LOOP_EXP__ITERATOR);
    }
    return iterator;
  }
   ...
   */
    ...
    switch (featureID)
    {
      ...
      case OCLPackage.LOOP_EXP__ITERATOR:
        getIterator().clear();
        getIterator().addAll((Collection<? extends Variable<CDOClassifier, CDOParameter>>)newValue);
        return;
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.LoopExp.class)
    {
      ...
      {
        case OCLPackage.LOOP_EXP__BODY: return ExpressionsPackage.LOOP_EXP__BODY;
        case OCLPackage.LOOP_EXP__ITERATOR: return ExpressionsPackage.LOOP_EXP__ITERATOR;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.LoopExp.class)
    {
      ...
      {
        case ExpressionsPackage.LOOP_EXP__BODY: return OCLPackage.LOOP_EXP__BODY;
        case ExpressionsPackage.LOOP_EXP__ITERATOR: return OCLPackage.LOOP_EXP__ITERATOR;
        default: return -1;
      }
    }
