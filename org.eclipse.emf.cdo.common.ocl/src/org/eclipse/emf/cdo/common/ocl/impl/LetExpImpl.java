 ...
 * </copyright>
 *
 * $Id: LetExpImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public class LetExpImpl
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.LetExp.class)
    {
      ...
      {
        case OCLPackage.LET_EXP__IN: return ExpressionsPackage.LET_EXP__IN;
        case OCLPackage.LET_EXP__VARIABLE: return ExpressionsPackage.LET_EXP__VARIABLE;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == org.eclipse.ocl.expressions.LetExp.class)
    {
      ...
      {
        case ExpressionsPackage.LET_EXP__IN: return OCLPackage.LET_EXP__IN;
        case ExpressionsPackage.LET_EXP__VARIABLE: return OCLPackage.LET_EXP__VARIABLE;
        default: return -1;
      }
    }
