 ...
 * </copyright>
 *
 * $Id: NavigationCallExpImpl.java,v 1.2 2009-01-04 17:56:36 estepper Exp $
 */
 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.cdo.common.ocl.impl.NavigationCallExpImpl#getQualifier
 * <em>Qualifier</em>}</li>
 * <li>
 * {@link org.eclipse.emf.cdo.common.ocl.impl.NavigationCallExpImpl#getNavigationSource
 * <em>Navigation Source</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class NavigationCallExpImpl
	...
	/**
	 * The cached value of the '{@link #getNavigationSource()
	 * <em>Navigation Source</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	public EList<OCLExpression<CDOClassifier>> getQualifier() {
		if (qualifier == null) {
			qualifier = new EObjectContainmentEList<OCLExpression<CDOClassifier>>(
				OCLExpression.class, this,
				OCLPackage.NAVIGATION_CALL_EXP__QUALIFIER);
		}
		return qualifier;
	}
			...
			if (navigationSource != oldNavigationSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						OCLPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE,
		...
		if (baseClass == org.eclipse.ocl.expressions.NavigationCallExp.class) {
			switch (baseFeatureID) {
				case ExpressionsPackage.NAVIGATION_CALL_EXP__QUALIFIER :
					return OCLPackage.NAVIGATION_CALL_EXP__QUALIFIER;
				case ExpressionsPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE :
					return OCLPackage.NAVIGATION_CALL_EXP__NAVIGATION_SOURCE;
				default :
					return -1;
			}
		}
