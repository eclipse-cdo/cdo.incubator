 ...
 * </copyright>
 *
 * $Id: CallExpImpl.java,v 1.3 2009-01-04 19:26:02 estepper Exp $
 */
...
public abstract class CallExpImpl
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.CALL_EXP__PROPERTY_START_POSITION, oldPropertyStartPosition, propertyStartPosition));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OCLPackage.CALL_EXP__PROPERTY_END_POSITION, oldPropertyEndPosition, propertyEndPosition));
  }
   ...
   */
    ...
    if (baseClass == CallingASTNode.class)
    {
      ...
      {
        case OCLPackage.CALL_EXP__PROPERTY_START_POSITION: return UtilitiesPackage.CALLING_AST_NODE__PROPERTY_START_POSITION;
        case OCLPackage.CALL_EXP__PROPERTY_END_POSITION: return UtilitiesPackage.CALLING_AST_NODE__PROPERTY_END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == org.eclipse.ocl.expressions.CallExp.class)
    {
      switch (derivedFeatureID)
      {
        case OCLPackage.CALL_EXP__SOURCE: return ExpressionsPackage.CALL_EXP__SOURCE;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == CallingASTNode.class)
    {
      ...
      {
        case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_START_POSITION: return OCLPackage.CALL_EXP__PROPERTY_START_POSITION;
        case UtilitiesPackage.CALLING_AST_NODE__PROPERTY_END_POSITION: return OCLPackage.CALL_EXP__PROPERTY_END_POSITION;
        default: return -1;
      }
    }
    if (baseClass == org.eclipse.ocl.expressions.CallExp.class)
    {
      switch (baseFeatureID)
      {
        case ExpressionsPackage.CALL_EXP__SOURCE: return OCLPackage.CALL_EXP__SOURCE;
        default: return -1;
      }
    }
