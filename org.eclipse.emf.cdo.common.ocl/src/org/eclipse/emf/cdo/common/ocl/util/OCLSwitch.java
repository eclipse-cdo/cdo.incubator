 ...
 * </copyright>
 *
 * $Id: OCLSwitch.java,v 1.2 2009-01-04 19:26:03 estepper Exp $
 */
   ...
   */
    ...
    switch (classifierID)
    {
      case OCLPackage.ANY_TYPE:
      {
        ...
        if (result == null) result = caseCDOClassifier(anyType);
        if (result == null) result = caseTypes_AnyType(anyType);
      ...
      case OCLPackage.BAG_TYPE:
      {
        ...
        if (result == null) result = caseTypes_BagType(bagType);
        if (result == null) result = caseCDOType(bagType);
        if (result == null) result = caseTypes_CollectionType(bagType);
      ...
      case OCLPackage.COLLECTION_TYPE:
      {
        ...
        if (result == null) result = caseCDOType(collectionType);
        if (result == null) result = caseTypes_CollectionType(collectionType);
      ...
      case OCLPackage.ELEMENT_TYPE:
      {
        ...
        if (result == null) result = caseCDOClass(elementType);
        if (result == null) result = caseTypes_ElementType(elementType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case OCLPackage.INVALID_TYPE:
      {
        ...
        if (result == null) result = caseCDOClassifier(invalidType);
        if (result == null) result = caseTypes_InvalidType(invalidType);
      ...
      case OCLPackage.MESSAGE_TYPE:
      {
        ...
        if (result == null) result = caseCDOClass(messageType);
        if (result == null) result = caseTypes_MessageType(messageType);
      ...
      case OCLPackage.ORDERED_SET_TYPE:
      {
        ...
        if (result == null) result = caseTypes_OrderedSetType(orderedSetType);
        if (result == null) result = caseCDOType(orderedSetType);
        if (result == null) result = caseTypes_CollectionType(orderedSetType);
      ...
      case OCLPackage.PRIMITIVE_TYPE:
      {
        ...
        if (result == null) result = caseCDOType(primitiveType);
        if (result == null) result = caseTypes_PrimitiveType(primitiveType);
      ...
      case OCLPackage.SEQUENCE_TYPE:
      {
        ...
        if (result == null) result = caseTypes_SequenceType(sequenceType);
        if (result == null) result = caseCDOType(sequenceType);
        if (result == null) result = caseTypes_CollectionType(sequenceType);
      ...
      case OCLPackage.SET_TYPE:
      {
        ...
        if (result == null) result = caseTypes_SetType(setType);
        if (result == null) result = caseCDOType(setType);
        if (result == null) result = caseTypes_CollectionType(setType);
      ...
      case OCLPackage.TUPLE_TYPE:
      {
        ...
        if (result == null) result = caseCDOClass(tupleType);
        if (result == null) result = caseCDOType(tupleType);
        if (result == null) result = caseTypes_TupleType(tupleType);
      ...
      case OCLPackage.TYPE_TYPE:
      {
        ...
        if (result == null) result = caseCDOClassifier(typeType);
        if (result == null) result = caseTypes_TypeType(typeType);
      ...
      case OCLPackage.VOID_TYPE:
      {
        ...
        if (result == null) result = caseCDOClassifier(voidType);
        if (result == null) result = caseTypes_VoidType(voidType);
      ...
      case OCLPackage.CONSTRAINT:
      {
        ...
        if (result == null) result = caseCDONamedElement(constraint);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case OCLPackage.EXPRESSION_IN_OCL:
      {
        ...
        if (result == null) result = caseUtilities_ExpressionInOCL(expressionInOCL);
      ...
      case OCLPackage.ASSOCIATION_CLASS_CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_AssociationClassCallExp(associationClassCallExp);
        if (result == null) result = caseFeatureCallExp(associationClassCallExp);
        if (result == null) result = caseExpressions_NavigationCallExp(associationClassCallExp);
        if (result == null) result = caseCallExp(associationClassCallExp);
        if (result == null) result = caseExpressions_FeatureCallExp(associationClassCallExp);
        if (result == null) result = caseOCLExpression(associationClassCallExp);
        if (result == null) result = caseExpressions_CallExp(associationClassCallExp);
        if (result == null) result = caseCDOTypedElement(associationClassCallExp);
        if (result == null) result = caseExpressions_OCLExpression(associationClassCallExp);
      ...
      case OCLPackage.BOOLEAN_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_BooleanLiteralExp(booleanLiteralExp);
        if (result == null) result = caseLiteralExp(booleanLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(booleanLiteralExp);
        if (result == null) result = caseOCLExpression(booleanLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(booleanLiteralExp);
        if (result == null) result = caseCDOTypedElement(booleanLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(booleanLiteralExp);
      ...
      case OCLPackage.CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_CallExp(callExp);
        if (result == null) result = caseCDOTypedElement(callExp);
        if (result == null) result = caseExpressions_OCLExpression(callExp);
      ...
      case OCLPackage.COLLECTION_ITEM:
      {
        ...
        if (result == null) result = caseExpressions_CollectionItem(collectionItem);
        if (result == null) result = caseCDOTypedElement(collectionItem);
        if (result == null) result = caseExpressions_CollectionLiteralPart(collectionItem);
      ...
      case OCLPackage.COLLECTION_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_CollectionLiteralExp(collectionLiteralExp);
        if (result == null) result = caseOCLExpression(collectionLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(collectionLiteralExp);
        if (result == null) result = caseCDOTypedElement(collectionLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(collectionLiteralExp);
      ...
      case OCLPackage.COLLECTION_LITERAL_PART:
      {
        ...
        if (result == null) result = caseCDOTypedElement(collectionLiteralPart);
        if (result == null) result = caseExpressions_CollectionLiteralPart(collectionLiteralPart);
      ...
      case OCLPackage.COLLECTION_RANGE:
      {
        ...
        if (result == null) result = caseExpressions_CollectionRange(collectionRange);
        if (result == null) result = caseCDOTypedElement(collectionRange);
        if (result == null) result = caseExpressions_CollectionLiteralPart(collectionRange);
      ...
      case OCLPackage.ENUM_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_EnumLiteralExp(enumLiteralExp);
        if (result == null) result = caseOCLExpression(enumLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(enumLiteralExp);
        if (result == null) result = caseCDOTypedElement(enumLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(enumLiteralExp);
      ...
      case OCLPackage.FEATURE_CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_FeatureCallExp(featureCallExp);
        if (result == null) result = caseOCLExpression(featureCallExp);
        if (result == null) result = caseExpressions_CallExp(featureCallExp);
        if (result == null) result = caseCDOTypedElement(featureCallExp);
        if (result == null) result = caseExpressions_OCLExpression(featureCallExp);
      ...
      case OCLPackage.IF_EXP:
      {
        ...
        if (result == null) result = caseExpressions_IfExp(ifExp);
        if (result == null) result = caseCDOTypedElement(ifExp);
        if (result == null) result = caseExpressions_OCLExpression(ifExp);
      ...
      case OCLPackage.INTEGER_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_IntegerLiteralExp(integerLiteralExp);
        if (result == null) result = casePrimitiveLiteralExp(integerLiteralExp);
        if (result == null) result = caseExpressions_NumericLiteralExp(integerLiteralExp);
        if (result == null) result = caseLiteralExp(integerLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(integerLiteralExp);
        if (result == null) result = caseOCLExpression(integerLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(integerLiteralExp);
        if (result == null) result = caseCDOTypedElement(integerLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(integerLiteralExp);
      ...
      case OCLPackage.UNLIMITED_NATURAL_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_UnlimitedNaturalLiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = casePrimitiveLiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = caseExpressions_NumericLiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = caseLiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = caseOCLExpression(unlimitedNaturalLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(unlimitedNaturalLiteralExp);
        if (result == null) result = caseCDOTypedElement(unlimitedNaturalLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(unlimitedNaturalLiteralExp);
      ...
      case OCLPackage.INVALID_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_InvalidLiteralExp(invalidLiteralExp);
        if (result == null) result = caseOCLExpression(invalidLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(invalidLiteralExp);
        if (result == null) result = caseCDOTypedElement(invalidLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(invalidLiteralExp);
      ...
      case OCLPackage.ITERATE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_IterateExp(iterateExp);
        if (result == null) result = caseCallExp(iterateExp);
        if (result == null) result = caseExpressions_LoopExp(iterateExp);
        if (result == null) result = caseOCLExpression(iterateExp);
        if (result == null) result = caseExpressions_CallExp(iterateExp);
        if (result == null) result = caseCDOTypedElement(iterateExp);
        if (result == null) result = caseExpressions_OCLExpression(iterateExp);
      ...
      case OCLPackage.ITERATOR_EXP:
      {
        ...
        if (result == null) result = caseExpressions_IteratorExp(iteratorExp);
        if (result == null) result = caseCallExp(iteratorExp);
        if (result == null) result = caseExpressions_LoopExp(iteratorExp);
        if (result == null) result = caseOCLExpression(iteratorExp);
        if (result == null) result = caseExpressions_CallExp(iteratorExp);
        if (result == null) result = caseCDOTypedElement(iteratorExp);
        if (result == null) result = caseExpressions_OCLExpression(iteratorExp);
      ...
      case OCLPackage.LET_EXP:
      {
        ...
        if (result == null) result = caseExpressions_LetExp(letExp);
        if (result == null) result = caseCDOTypedElement(letExp);
        if (result == null) result = caseExpressions_OCLExpression(letExp);
      ...
      case OCLPackage.LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_LiteralExp(literalExp);
        if (result == null) result = caseCDOTypedElement(literalExp);
        if (result == null) result = caseExpressions_OCLExpression(literalExp);
      ...
      case OCLPackage.LOOP_EXP:
      {
        ...
        if (result == null) result = caseExpressions_LoopExp(loopExp);
        if (result == null) result = caseOCLExpression(loopExp);
        if (result == null) result = caseExpressions_CallExp(loopExp);
        if (result == null) result = caseCDOTypedElement(loopExp);
        if (result == null) result = caseExpressions_OCLExpression(loopExp);
      ...
      case OCLPackage.MESSAGE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_MessageExp(messageExp);
        if (result == null) result = caseCDOTypedElement(messageExp);
        if (result == null) result = caseExpressions_OCLExpression(messageExp);
      ...
      case OCLPackage.NAVIGATION_CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_NavigationCallExp(navigationCallExp);
        if (result == null) result = caseCallExp(navigationCallExp);
        if (result == null) result = caseExpressions_FeatureCallExp(navigationCallExp);
        if (result == null) result = caseOCLExpression(navigationCallExp);
        if (result == null) result = caseExpressions_CallExp(navigationCallExp);
        if (result == null) result = caseCDOTypedElement(navigationCallExp);
        if (result == null) result = caseExpressions_OCLExpression(navigationCallExp);
      ...
      case OCLPackage.NULL_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_NullLiteralExp(nullLiteralExp);
        if (result == null) result = caseOCLExpression(nullLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(nullLiteralExp);
        if (result == null) result = caseCDOTypedElement(nullLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(nullLiteralExp);
      ...
      case OCLPackage.NUMERIC_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_NumericLiteralExp(numericLiteralExp);
        if (result == null) result = caseLiteralExp(numericLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(numericLiteralExp);
        if (result == null) result = caseOCLExpression(numericLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(numericLiteralExp);
        if (result == null) result = caseCDOTypedElement(numericLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(numericLiteralExp);
      ...
      case OCLPackage.OCL_EXPRESSION:
      {
        ...
        if (result == null) result = caseCDOTypedElement(oclExpression);
        if (result == null) result = caseExpressions_OCLExpression(oclExpression);
      ...
      case OCLPackage.OPERATION_CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_OperationCallExp(operationCallExp);
        if (result == null) result = caseCallExp(operationCallExp);
        if (result == null) result = caseExpressions_FeatureCallExp(operationCallExp);
        if (result == null) result = caseOCLExpression(operationCallExp);
        if (result == null) result = caseExpressions_CallExp(operationCallExp);
        if (result == null) result = caseCDOTypedElement(operationCallExp);
        if (result == null) result = caseExpressions_OCLExpression(operationCallExp);
      ...
      case OCLPackage.PRIMITIVE_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(primitiveLiteralExp);
        if (result == null) result = caseOCLExpression(primitiveLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(primitiveLiteralExp);
        if (result == null) result = caseCDOTypedElement(primitiveLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(primitiveLiteralExp);
      ...
      case OCLPackage.PROPERTY_CALL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_PropertyCallExp(propertyCallExp);
        if (result == null) result = caseFeatureCallExp(propertyCallExp);
        if (result == null) result = caseExpressions_NavigationCallExp(propertyCallExp);
        if (result == null) result = caseCallExp(propertyCallExp);
        if (result == null) result = caseExpressions_FeatureCallExp(propertyCallExp);
        if (result == null) result = caseOCLExpression(propertyCallExp);
        if (result == null) result = caseExpressions_CallExp(propertyCallExp);
        if (result == null) result = caseCDOTypedElement(propertyCallExp);
        if (result == null) result = caseExpressions_OCLExpression(propertyCallExp);
      ...
      case OCLPackage.REAL_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_RealLiteralExp(realLiteralExp);
        if (result == null) result = casePrimitiveLiteralExp(realLiteralExp);
        if (result == null) result = caseExpressions_NumericLiteralExp(realLiteralExp);
        if (result == null) result = caseLiteralExp(realLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(realLiteralExp);
        if (result == null) result = caseOCLExpression(realLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(realLiteralExp);
        if (result == null) result = caseCDOTypedElement(realLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(realLiteralExp);
      ...
      case OCLPackage.STATE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_StateExp(stateExp);
        if (result == null) result = caseCDOTypedElement(stateExp);
        if (result == null) result = caseExpressions_OCLExpression(stateExp);
      ...
      case OCLPackage.STRING_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_StringLiteralExp(stringLiteralExp);
        if (result == null) result = caseLiteralExp(stringLiteralExp);
        if (result == null) result = caseExpressions_PrimitiveLiteralExp(stringLiteralExp);
        if (result == null) result = caseOCLExpression(stringLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(stringLiteralExp);
        if (result == null) result = caseCDOTypedElement(stringLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(stringLiteralExp);
      ...
      case OCLPackage.TUPLE_LITERAL_EXP:
      {
        ...
        if (result == null) result = caseExpressions_TupleLiteralExp(tupleLiteralExp);
        if (result == null) result = caseOCLExpression(tupleLiteralExp);
        if (result == null) result = caseExpressions_LiteralExp(tupleLiteralExp);
        if (result == null) result = caseCDOTypedElement(tupleLiteralExp);
        if (result == null) result = caseExpressions_OCLExpression(tupleLiteralExp);
      ...
      case OCLPackage.TUPLE_LITERAL_PART:
      {
        ...
        if (result == null) result = caseCDOTypedElement(tupleLiteralPart);
        if (result == null) result = caseExpressions_TupleLiteralPart(tupleLiteralPart);
      ...
      case OCLPackage.TYPE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_TypeExp(typeExp);
        if (result == null) result = caseCDOTypedElement(typeExp);
        if (result == null) result = caseExpressions_OCLExpression(typeExp);
      ...
      case OCLPackage.UNSPECIFIED_VALUE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_UnspecifiedValueExp(unspecifiedValueExp);
        if (result == null) result = caseCDOTypedElement(unspecifiedValueExp);
        if (result == null) result = caseExpressions_OCLExpression(unspecifiedValueExp);
      ...
      case OCLPackage.VARIABLE:
      {
        ...
        if (result == null) result = caseCDOTypedElement(variable);
        if (result == null) result = caseExpressions_Variable(variable);
      ...
      case OCLPackage.VARIABLE_EXP:
      {
        ...
        if (result == null) result = caseExpressions_VariableExp(variableExp);
        if (result == null) result = caseCDOTypedElement(variableExp);
        if (result == null) result = caseExpressions_OCLExpression(variableExp);
