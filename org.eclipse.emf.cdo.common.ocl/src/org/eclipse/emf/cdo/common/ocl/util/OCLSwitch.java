 ...
 * </copyright>
 *
 * $Id: OCLSwitch.java,v 1.1 2009-01-04 17:56:37 estepper Exp $
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OCLPackage.BAG_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(bagType);
				if (result == null)
			...
			case OCLPackage.COLLECTION_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(collectionType);
				if (result == null)
			...
			case OCLPackage.ORDERED_SET_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(orderedSetType);
				if (result == null)
			...
			case OCLPackage.PRIMITIVE_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(primitiveType);
				if (result == null)
			...
			case OCLPackage.SEQUENCE_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(sequenceType);
				if (result == null)
			...
			case OCLPackage.SET_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(setType);
				if (result == null)
			...
			case OCLPackage.TUPLE_TYPE : {
				...
				if (result == null)
					result = caseCDODataType(tupleType);
				if (result == null)
