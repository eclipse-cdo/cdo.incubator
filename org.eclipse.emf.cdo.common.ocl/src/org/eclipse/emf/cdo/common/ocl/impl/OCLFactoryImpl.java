 ...
 * </copyright>
 *
 * $Id: OCLFactoryImpl.java,v 1.2 2009-01-04 19:26:02 estepper Exp $
 */
...
public class OCLFactoryImpl
   ...
   */
    ...
    try
    {
      OCLFactory theOCLFactory = (OCLFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/ocl/1.1.0/CDO"); 
   ...
   */
    ...
    switch (eClass.getClassifierID())
    {
      ...
      case OCLPackage.ELEMENT_TYPE: return createElementType();
      ...
      case OCLPackage.TYPE_TYPE: return createTypeType();
      case OCLPackage.VOID_TYPE: return createVoidType();
      case OCLPackage.CALL_OPERATION_ACTION: return createCallOperationAction();
      case OCLPackage.CONSTRAINT: return createConstraint();
      case OCLPackage.SEND_SIGNAL_ACTION: return createSendSignalAction();
      ...
      case OCLPackage.UNSPECIFIED_VALUE_EXP: return createUnspecifiedValueExp();
