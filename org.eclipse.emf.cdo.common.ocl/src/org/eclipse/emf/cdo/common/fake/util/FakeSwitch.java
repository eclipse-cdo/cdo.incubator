 ...
 * </copyright>
 *
 * $Id: FakeSwitch.java,v 1.1 2009-01-04 17:56:37 estepper Exp $
 */
...
public class FakeSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FakePackage.CDO_DATA_TYPE : {
				CDODataType cdoDataType = (CDODataType) theEObject;
				T result = caseCDODataType(cdoDataType);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * <em>CDO Revision</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CDO Feature</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CDO Data Type</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	 ...
	 * @generated
	 */
	public T caseCDODataType(CDODataType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CDO Enum Literal</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CDO Operation</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>CDO Parameter</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
