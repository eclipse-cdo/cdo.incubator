 ...
 * </copyright>
 *
 * $Id: FakeFactoryImpl.java,v 1.1 2009-01-04 17:56:37 estepper Exp $
 */
...
public class FakeFactoryImpl
	...
	public static FakeFactory init() {
		try {
			FakeFactory theFakeFactory = (FakeFactory) EPackage.Registry.INSTANCE
				.getEFactory("http://www.eclipse.org/ocl/2.0.0/CDO/Fake");
	 ...
	 * @generated
	 */
	public CDODataType createCDODataType() {
		CDODataTypeImpl cdoDataType = new CDODataTypeImpl();
		return cdoDataType;
	}
