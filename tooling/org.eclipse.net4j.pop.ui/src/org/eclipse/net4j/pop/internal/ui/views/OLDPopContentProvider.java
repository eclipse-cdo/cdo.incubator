 ...
 * @author Eike Stepper
 */
public class OLDPopContentProvider extends AdapterFactoryContentProvider
{
  protected Object input;

  public OLDPopContentProvider(AdapterFactory adapterFactory)
  {
   ...
   * @author Eike Stepper
   */
  public static class Streams extends OLDPopContentProvider implements IListener
  {
   ...
   * @author Eike Stepper
   */
  public static class Committers extends OLDPopContentProvider
  {
   ...
   * @author Eike Stepper
   */
  public static class Branches extends OLDPopContentProvider
  {
   ...
   * @author Eike Stepper
   */
  public static class Targets extends OLDPopContentProvider
  {
   ...
   * @author Eike Stepper
   */
  public static class Deliveries extends OLDPopContentProvider
  {
   ...
   * @author Eike Stepper
   */
  public static class Merges extends OLDPopContentProvider
  {
