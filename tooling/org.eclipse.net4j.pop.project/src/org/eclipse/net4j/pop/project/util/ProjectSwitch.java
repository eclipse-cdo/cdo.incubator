 ...
 *
 * $Id: ProjectSwitch.java,v 1.16 2008-08-05 18:39:27 estepper Exp $
 */
...
public class ProjectSwitch<T>
{
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Repository Module</em>'. <!-- begin-user-doc
   * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * 
   * @param object
   *          the target of the switch.
