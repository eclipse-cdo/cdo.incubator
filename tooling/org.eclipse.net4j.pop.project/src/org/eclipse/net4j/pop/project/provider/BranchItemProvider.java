 ...
 *
 * $Id: BranchItemProvider.java,v 1.2 2008-07-31 13:35:40 estepper Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.net4j.pop.project.Branch} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
    ...
    IItemColorProvider, IItemFontProvider
{
  ...
  /**
   * This adds a property descriptor for the Branches feature. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   */
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Branch_branches_feature"), //$NON-NLS-1$
        getString("_UI_PropertyDescriptor_description", "_UI_Branch_branches_feature", "_UI_Branch_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ProjectPackage.Literals.BRANCH__BRANCHES, true, false, true, null, null, null));
  }
  ...
  protected void addStreamPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        ...
        ProjectPackage.Literals.BRANCH__STREAM, true, false, true, null, null, null));
  }
