 ...
 *
 * $Id: RepositoryModule.java,v 1.1 2008-08-05 14:48:09 estepper Exp $
 */
 ...
 *   <li>{@link org.eclipse.net4j.pop.project.RepositoryModule#getAdapterDescriptor <em>Adapter Descriptor</em>}</li>
...
public interface RepositoryModule extends PopElement
{
   ...
   * It is bidirectional and its opposite is '{@link org.eclipse.net4j.pop.project.PopProject#getPrimaryModule <em>Primary Module</em>}'.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.project.RepositoryModule#getPopProject <em>Pop Project</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @model dataType="org.eclipse.net4j.pop.project.RepositoryAdapter" required="true" transient="true" changeable="false" volatile="true" derived="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.project.RepositoryModule#getAdapterType <em>Adapter Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Adapter Descriptor</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Adapter Descriptor</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Adapter Descriptor</em>' attribute.
   * @see #setAdapterDescriptor(String)
   * @see org.eclipse.net4j.pop.project.ProjectPackage#getRepositoryModule_AdapterDescriptor()
   * @model required="true"
   * @generated
   */
  String getAdapterDescriptor();

  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.project.RepositoryModule#getAdapterDescriptor <em>Adapter Descriptor</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Adapter Descriptor</em>' attribute.
   * @see #getAdapterDescriptor()
   * @generated
   */
  void setAdapterDescriptor(String value);

  /**
   * Returns the value of the '<em><b>Module Descriptor</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Module Descriptor</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.project.RepositoryModule#getModuleDescriptor <em>Module Descriptor</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Module Descriptor</em>' attribute.
