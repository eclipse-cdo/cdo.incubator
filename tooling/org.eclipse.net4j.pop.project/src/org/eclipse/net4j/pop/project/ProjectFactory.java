 ...
 *
 * $Id: ProjectFactory.java,v 1.4 2008-08-01 08:15:15 estepper Exp $
 */
...
public interface ProjectFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Pop Project</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Code Repository</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Code Root</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return a new object of class '<em>Code Root</em>'.
   * @generated
   */
  CodeRoot createCodeRoot();

  /**
   * Returns a new object of class '<em>Committer</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Task Stream</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Root Stream</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Merge</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
