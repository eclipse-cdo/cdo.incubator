...
public interface ProjectPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Repository Login</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @generated
   * @ordered
   */
  ...
  /**
   * The meta object id for the '{@link org.eclipse.net4j.pop.project.impl.RepositoryModuleImpl
   * <em>Repository Module</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * @ordered
   */
  int CHECKOUT_DISCRIMINATOR_FEATURE_COUNT = BasePackage.POP_ELEMENT_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.net4j.pop.project.PopProject#getTeamProvider
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.net4j.pop.project.PopProject#getRepositoryUrl
  ...
  /**
   * Returns the meta object for the containment reference '
   * {@link org.eclipse.net4j.pop.project.PopProject#getMainBranch <em>Main Branch</em>}'. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the container reference '{@link org.eclipse.net4j.pop.project.Committer#getPopProject
   * <em>Pop Project</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.net4j.pop.project.Committer#getRepositoryLogin
   * <em>Repository Login</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.net4j.pop.project.RepositoryModule
   * <em>Repository Module</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   ...
   * {@link org.eclipse.net4j.pop.project.RepositoryModule#getPopProject <em>Pop Project</em>}'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
   * @return the meta object for the container reference '<em>Pop Project</em>'.
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.net4j.pop.project.RepositoryModule#getAdapter
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.net4j.pop.project.RepositoryModule#getAdapterType
  ...
  /**
   * Returns the meta object for the container reference '{@link org.eclipse.net4j.pop.project.MainBranch#getPopProject
   * <em>Pop Project</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @return the meta object for the container reference '<em>Pop Project</em>'.
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Repository Login</b></em>' attribute feature. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * The meta object literal for the '{@link org.eclipse.net4j.pop.project.impl.RepositoryModuleImpl
     * <em>Repository Module</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see org.eclipse.net4j.pop.project.impl.RepositoryModuleImpl
     * @see org.eclipse.net4j.pop.project.impl.ProjectPackageImpl#getRepositoryModule()
