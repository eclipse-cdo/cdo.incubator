 ...
 *
 * $Id: ProjectAdapterFactory.java,v 1.14 2008-08-05 18:39:27 estepper Exp $
 */
...
public class ProjectAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.net4j.pop.project.RepositoryModule
   * <em>Repository Module</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
   * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
   * end-user-doc -->
   * 
   * @return the new adapter.
