 ...
 *
 * $Id: ProjectPackageImpl.java,v 1.1 2008-07-31 12:33:19 estepper Exp $
 */
...
public class ProjectPackageImpl extends EPackageImpl implements ProjectPackage
{
   ...
   * @generated
   */
  public EReference getCodeRoot_CodeRepository()
  {
   ...
   * @generated
   */
  public EReference getCommitter_CodeRepository()
  {
   ...
   * @generated
   */
  public EReference getMainBranch_CodeRepository()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(codeRootEClass, CODE_ROOT__CODE_REPOSITORY);

    committerEClass = createEClass(COMMITTER);
    createEReference(committerEClass, COMMITTER__CODE_REPOSITORY);
    ...
    createEReference(mainBranchEClass, MAIN_BRANCH__CODE_REPOSITORY);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(
        ...
        this.getCodeRoot(),
        this.getCodeRoot_CodeRepository(),
    ...
    initEReference(
        ...
        this.getCommitter(),
        this.getCommitter_CodeRepository(),
    ...
    initEReference(
        ...
        this.getMainBranch(),
        this.getMainBranch_CodeRepository(),
    ...
    initEReference(
        getCodeRoot_CodeRepository(),
        this.getCodeRepository(),
        this.getCodeRepository_CodeRoots(),
        "codeRepository", null, 1, 1, CodeRoot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

    initEClass(committerEClass, Committer.class, "Committer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
    initEReference(
        getCommitter_CodeRepository(),
        this.getCodeRepository(),
        this.getCodeRepository_Committers(),
        "codeRepository", null, 1, 1, Committer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEAttribute(
        getCommitter_Id(),
        ecorePackage.getEString(),
    ...
    initEReference(
        getMainBranch_CodeRepository(),
        this.getCodeRepository(),
        this.getCodeRepository_MainBranch(),
        "codeRepository", null, 1, 1, MainBranch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
