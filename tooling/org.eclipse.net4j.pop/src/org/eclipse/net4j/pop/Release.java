 ...
 *
 * $Id: Release.java,v 1.1 2008-08-07 17:42:12 estepper Exp $
 */
...
public interface Release extends Target
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Maintenance</em>' reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.Release#getMaintenance <em>Maintenance</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @model dataType="org.eclipse.net4j.pop.Version" required="true"
   * @generated
   */
  Version getVersion();

  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.Release#getVersion <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Stream</em>' container reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.Release#getStream <em>Stream</em>}' container reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
