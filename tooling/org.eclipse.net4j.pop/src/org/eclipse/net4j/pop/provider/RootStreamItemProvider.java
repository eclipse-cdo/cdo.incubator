 ...
 *
 * $Id: RootStreamItemProvider.java,v 1.1 2008-08-07 17:42:14 estepper Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.net4j.pop.RootStream} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
  ...
  {
    String label = ((RootStream)object).getId();
    return label == null || label.length() == 0 ? getString("_UI_RootStream_type") : //$NON-NLS-1$
        getString("_UI_RootStream_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
