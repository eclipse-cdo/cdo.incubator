 ...
 *
 * $Id: DeliveryStreamItemProvider.java,v 1.1 2008-08-07 17:42:13 estepper Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.net4j.pop.DeliveryStream} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
  ...
  /**
   * This returns DeliveryStream.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    String label = ((DeliveryStream)object).getId();
    return label == null || label.length() == 0 ? getString("_UI_DeliveryStream_type") : //$NON-NLS-1$
        getString("_UI_DeliveryStream_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
