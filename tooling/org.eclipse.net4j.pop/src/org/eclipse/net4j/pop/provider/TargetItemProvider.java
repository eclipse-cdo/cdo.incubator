 ...
 *
 * $Id: TargetItemProvider.java,v 1.2 2008-08-09 09:58:11 estepper Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.net4j.pop.Target} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
    ...
    ITableItemLabelProvider, ITableItemColorProvider, ITableItemFontProvider, IItemColorProvider, IItemFontProvider
{
  ...
  protected void addDatePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Target_date_feature"), //$NON-NLS-1$
        getString("_UI_PropertyDescriptor_description", "_UI_Target_date_feature", "_UI_Target_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        PopPackage.Literals.TARGET__DATE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
  }
  ...
  {
    itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
        .getRootAdapterFactory(), getResourceLocator(), getString("_UI_Target_tasks_feature"), //$NON-NLS-1$
        getString("_UI_PropertyDescriptor_description", "_UI_Target_tasks_feature", "_UI_Target_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        PopPackage.Literals.TARGET__TASKS, true, false, true, null, null, null));
  }
