 ...
 *
 * $Id: ReleaseImpl.java,v 1.3 2008-08-09 18:31:09 estepper Exp $
 */
...
public class ReleaseImpl extends TargetImpl implements Release
{
  ...
  {
    return PopPackage.Literals.RELEASE;
  }
    ...
    if (maintenance != null && maintenance.eIsProxy())
    {
      ...
      if (maintenance != oldMaintenance)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PopPackage.RELEASE__MAINTENANCE, oldMaintenance,
              maintenance));
      }
    }
    return maintenance;
  ...
  public NotificationChain basicSetMaintenance(MaintenanceStream newMaintenance, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PopPackage.RELEASE__MAINTENANCE,
  ...
  public void setMaintenance(MaintenanceStream newMaintenance)
  {
    if (newMaintenance != maintenance)
    {
      ...
      if (maintenance != null)
        msgs = ((InternalEObject)maintenance).eInverseRemove(this, PopPackage.MAINTENANCE_STREAM__BASELINE,
            MaintenanceStream.class, msgs);
      if (newMaintenance != null)
        msgs = ((InternalEObject)newMaintenance).eInverseAdd(this, PopPackage.MAINTENANCE_STREAM__BASELINE,
            MaintenanceStream.class, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, PopPackage.RELEASE__MAINTENANCE, newMaintenance,
          newMaintenance));
  }
  ...
  public void setVersion(Version newVersion)
  {
    ...
    version = newVersion;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PopPackage.RELEASE__VERSION, oldVersion, version));
  }
  ...
  {
    if (eContainerFeatureID != PopPackage.RELEASE__STREAM)
      return null;
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newStream, PopPackage.RELEASE__STREAM, msgs);
    return msgs;
  }
  ...
  {
    if (newStream != eInternalContainer() || (eContainerFeatureID != PopPackage.RELEASE__STREAM && newStream != null))
    {
      ...
      if (newStream != null)
        msgs = ((InternalEObject)newStream).eInverseAdd(this, PopPackage.INTEGRATION_STREAM__RELEASES,
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, PopPackage.RELEASE__STREAM, newStream, newStream));
  }
  ...
  public EList<Milestone> getMilestones()
  {
    if (milestones == null)
    {
      milestones = new EObjectContainmentWithInverseEList.Resolving<Milestone>(Milestone.class, this,
          PopPackage.RELEASE__MILESTONES, PopPackage.MILESTONE__RELEASE);
    }
    return milestones;
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
    ...
    {
    case PopPackage.RELEASE__STREAM:
      return eInternalContainer().eInverseRemove(this, PopPackage.INTEGRATION_STREAM__RELEASES,
          IntegrationStream.class, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    ...
    case PopPackage.RELEASE__VERSION:
      return getVersion();
    case PopPackage.RELEASE__STREAM:
      if (resolve)
        return getStream();
