...
{
  /**
   * Returns the value of the '<em><b>Checkout</b></em>' reference. It is bidirectional and its opposite is '
   * {@link org.eclipse.net4j.pop.Checkout#getWorkspaceSpecification <em>Workspace Specification</em>}'. <!--
   * begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Secondary Modules</b></em>' containment reference list. The list contents are of
   * type {@link org.eclipse.net4j.pop.SecondaryModule}. It is bidirectional and its opposite is '
   * {@link org.eclipse.net4j.pop.SecondaryModule#getWorkspaceSpecification <em>Workspace Specification</em>}'. <!--
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Secondary Modules</em>' containment reference list isn't clear, there really should be
