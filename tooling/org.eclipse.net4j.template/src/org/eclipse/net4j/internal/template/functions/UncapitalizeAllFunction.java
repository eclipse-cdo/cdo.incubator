...
public class UncapitalizeAllFunction extends TemplateFunction
{
  public UncapitalizeAllFunction()
  {
    super("uncapitalize-all");
  }

  public String evaluate(String referenceValue, List<String> arguments)
  {
    return StringUtil.uncapAll(referenceValue);
  }
}
