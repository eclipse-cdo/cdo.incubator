 ...
 *
 * $Id: ProductItemProviderAdapterFactory.java,v 1.1 2008-07-31 12:33:18 estepper Exp $
 */
package org.eclipse.net4j.pop.product.provider;

import org.eclipse.net4j.pop.product.ProductPackage;
import org.eclipse.net4j.pop.product.util.ProductActivator;
    ...
    IChangeNotifier, IDisposable, IChildCreationExtender
{
  ...
  protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(
      ProductActivator.INSTANCE, ProductPackage.eNS_URI);
  ...
  public void dispose()
  {
    if (popProductItemProvider != null) popProductItemProvider.dispose();
    if (workingSetItemProvider != null) workingSetItemProvider.dispose();
    ...
    if (archiveContentItemProvider != null) archiveContentItemProvider.dispose();
  }
