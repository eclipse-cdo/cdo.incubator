 ...
 *
 * $Id: ProductPackageImpl.java,v 1.3 2008-08-01 08:14:45 estepper Exp $
 */
...
public class ProductPackageImpl extends EPackageImpl implements ProductPackage
{
  ...
  {
    return (EReference)popProductEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(workingSetEClass, WORKING_SET__WORKSPACE_SPEC);
    ...
    createEReference(workspaceProjectEClass, WORKSPACE_PROJECT__CODE_ROOT);
    createEAttribute(workspaceProjectEClass, WORKSPACE_PROJECT__CODE_PATH);

    workspaceConfiguratorEClass = createEClass(WORKSPACE_CONFIGURATOR);
    createEReference(workspaceConfiguratorEClass, WORKSPACE_CONFIGURATOR__WORKSPACE_SPEC);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(
        ...
        this.getWorkspaceProject_WorkspaceSpec(),
    ...
    initEReference(
        ...
        this.getWorkingSet(),
        this.getWorkingSet_WorkspaceSpec(),
    ...
    initEReference(
        ...
        this.getWorkspaceConfigurator_WorkspaceSpec(),
    ...
    initEReference(
        getWorkingSet_WorkspaceSpec(),
        this.getPopProduct(),
        this.getPopProduct_WorkingSets(),
        "workspaceSpec", null, 1, 1, WorkingSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    ...
    initEReference(
        getWorkspaceProject_WorkspaceSpec(),
        this.getPopProduct(),
    ...
    initEReference(
        getWorkspaceProject_CodeRoot(),
        theProjectPackage.getCodeRoot(),
        null,
        "codeRoot", null, 1, 1, WorkspaceProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    initEAttribute(
        getWorkspaceProject_CodePath(),
        ecorePackage.getEString(),
        "codePath", null, 0, 1, WorkspaceProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
    ...
    initEReference(
        getWorkspaceConfigurator_WorkspaceSpec(),
        this.getPopProduct(),
        this.getPopProduct_Configurators(),
        "workspaceSpec", null, 1, 1, WorkspaceConfigurator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
