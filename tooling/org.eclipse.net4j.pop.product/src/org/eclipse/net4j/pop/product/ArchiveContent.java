 ...
 *
 * $Id: ArchiveContent.java,v 1.3 2008-08-01 08:14:44 estepper Exp $
 */
...
{
  /**
   * Returns the value of the '<em><b>Archive</b></em>' container reference. It is bidirectional and its opposite is '
   * {@link org.eclipse.net4j.pop.product.Archive#getContent <em>Content</em>}'. <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.net4j.pop.product.ArchiveContent#getArchive <em>Archive</em>}' container
   * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @param value
   *          the new value of the '<em>Archive</em>' container reference.
   * @see #getArchive()
   * @generated
   */
