 ...
 *
 * $Id: PDESwitch.java,v 1.3 2008-08-05 14:47:45 estepper Exp $
 */
...
public class PDESwitch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    ...
    case PDEPackage.TARGET_PLATFORM_CHECKER:
    {
      ...
      if (result == null)
        result = caseJREChecker(targetPlatformChecker);
      if (result == null)
        result = caseWorkspaceConfigurator(targetPlatformChecker);
      if (result == null)
    ...
    case PDEPackage.PDE_CONFIGURATOR:
    {
      ...
      if (result == null)
        result = caseWorkspaceConfigurator(pdeConfigurator);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.API_BASELINE:
    {
      ...
      if (result == null)
        result = casePDEConfigurator(apiBaseline);
      if (result == null)
        result = caseWorkspaceConfigurator(apiBaseline);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.TARGET_PLATFORM:
    {
      ...
      if (result == null)
        result = casePDEConfigurator(targetPlatform);
      if (result == null)
        result = caseWorkspaceConfigurator(targetPlatform);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.PDE_PROJECT:
    {
      ...
      if (result == null)
        result = caseWorkspaceProject(pdeProject);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    ...
    case PDEPackage.PLUGIN_ENTITY:
    {
      ...
      if (result == null)
        result = casePDEEntity(pluginEntity);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.PLUGIN:
    {
      ...
      if (result == null)
        result = casePluginEntity(plugin);
      if (result == null)
        result = casePDEEntity(plugin);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.FRAGMENT:
    {
      ...
      if (result == null)
        result = casePluginEntity(fragment);
      if (result == null)
        result = casePDEEntity(fragment);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.ZIP_DISTRIBUTION:
    {
      ...
      if (result == null)
        result = casePDEDistribution(zipDistribution);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
    case PDEPackage.POP_DISTRIBUTION:
    {
      ...
      if (result == null)
        result = casePDEDistribution(popDistribution);
      if (result == null)
        result = defaultCase(theEObject);
      return result;
    }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Plugin Entity</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * @param object the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Zip Distribution</em>'.
   * <!-- begin-user-doc
   * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * @param object the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Pop Distribution</em>'.
   * <!-- begin-user-doc
   * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * @param object the target of the switch.
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>JRE Checker</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
   * @param object the target of the switch.
