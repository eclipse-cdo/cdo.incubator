 ...
 *
 * $Id: PDEProject.java,v 1.4 2008-08-05 18:38:57 estepper Exp $
 */
...
{
  /**
   * Returns the value of the '<em><b>Entity</b></em>' containment reference. It is bidirectional and its opposite is '
   * {@link org.eclipse.net4j.pop.pde.PDEEntity#getProject <em>Project</em>}'. <!-- begin-user-doc -->
   * <p>
   ...
   * @model opposite="project" containment="true" required="true" transient="true" changeable="false" volatile="true"
   *        derived="true"
   * @generated
   */
  PDEEntity getEntity();
