 ...
 *
 * $Id: PDEProjectItemProvider.java,v 1.3 2008-08-05 14:47:45 estepper Exp $
 */
    ...
    IItemColorProvider, IItemFontProvider
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(PDEPackage.Literals.PDE_PROJECT__ENTITY);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/PDEProject")); //$NON-NLS-1$
  }
  ...
  {
    String label = ((PDEProject)object).getName();
    return label == null || label.length() == 0 ? getString("_UI_PDEProject_type") : //$NON-NLS-1$
        getString("_UI_PDEProject_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(PDEProject.class))
    {
