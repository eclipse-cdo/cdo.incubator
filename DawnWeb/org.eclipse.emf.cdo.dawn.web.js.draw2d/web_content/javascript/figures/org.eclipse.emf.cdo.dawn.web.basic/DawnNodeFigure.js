 ...
 */
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure = function(/* :String */className)
{
...
// org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype = new
// draw2d.Node;
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype = new draw2d.CompartmentFigure;
/** @private * */
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.type = "org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure";
 ...
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.setWorkflow = function(
 ...
 * 
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.setClassName = function(
/* :String */name)
{

	// this.headerLabel.style.whiteSpace = "nowrap";
	// this.headerLabel.innerHTML = "<img
	// src=\"javascript/dawn/gmf/de.mf.eclipse.plugins.dawn.diagram/icons/full/obj16/Klasse.gif\"
	// alt=\"_\">"+ name;
	//	
	// this.recalculateSize();
}
 ...
 * 
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.setId = function(/* :String */name)
{
	this.id = name;
}
 ...
 * 
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.setDimension = function(/* :int */w, /* :int */
h)
{
 ...
 * @private
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.createHTMLElement = function()
{
	var item = document.createElement('div');
	// item.style.MozBorderRadius="10px";
...
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.addChild = function(child)
{
 ...
 * @private
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.recalculateSize = function(
/* :String */name)
{
 ...
 * @private
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.getWidth = function()
{
 ...
 * @privates
 ******************************************************************************/
org.eclipse.emf.cdo.dawn.web.basic.DawnNodeFigure.prototype.getHeight = function()
{
