 ...
 * @author Eike Stepper
 */
public class ConnectIndication extends IndicationWithResponse
{
  private static final ContextTracer TRACER = new ContextTracer(OM.DEBUG, ConnectIndication.class);
