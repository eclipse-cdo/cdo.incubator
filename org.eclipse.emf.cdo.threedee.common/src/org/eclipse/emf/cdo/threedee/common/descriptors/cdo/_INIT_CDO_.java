...
public class _INIT_CDO_
{
  public static void init(Registry registry)
  {
    ...
    registry.register(new BranchManagerDescriptor(), color, 0.9f);
    registry.register(new BranchDescriptor(), color, 0.7f);

    registry.register(new PackageRegistryDescriptor(), color, 0.9f);
    registry.register(new PackageUnitDescriptor(), color, 0.7f);
    registry.register(new PackageInfoDescriptor(), color, 0.6f);

    registry.register(new RevisionManagerDescriptor(), color, 0.9f);
